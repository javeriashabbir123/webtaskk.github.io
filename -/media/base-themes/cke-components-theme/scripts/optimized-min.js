    ...
    return t.prototype.update = function() {
        ...
        function u(r) {
            ...
            h.on("slide-changed", function() {
                var n = u.find(".active");
                n.attr("tabindex", "0");
                u.find(document.activeElement).length;
        ...
        function o(t) {
            var i = t.owner,
                ...
                f = function() {
                    r.removeClass("paused")
                },
                o = function() {
                    t.preventScheduling = !0;
                    i.descheduleSlide(t);
                    i.executeOnTimers("update", t);
                    t.timeIndicator !== null && t.timeIndicator.pause()
                },
                s = function() {
                    t.preventScheduling = !1;
                    i.scheduleSlide(t)
                };
            n(window).on("pause-carousel", function() {
                t.preventScheduling = !0;
                i.descheduleSlide(t);
                u()
            });
            n(window).on("play-carousel", function() {
                t.preventScheduling = !1;
                i.scheduleSlide(t);
                f()
            })
